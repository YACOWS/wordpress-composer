...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder ".", "/storage/#{vpdj_config['user']}/projects/#{vpdj_config['domain_name']}"
  # Path to the included files for Puppet.
  config.vm.synced_folder "templates", vpdj_config["inc_file_path"]
  ...
  config.vm.provision "puppet" do |puppet|
    ...
    puppet.facter = {
      ...
      "replication_db_user" => vpdj_config["replication_db_user"],
      "replication_db_password" => vpdj_config["replication_db_password"],
      "replication_db_host" => vpdj_config["replication_db_host"],
    }
  end
